    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between bg-gray-50 border rounded-lg px-3 py-2">
        <p className="text-sm text-gray-700 truncate max-w-[200px]">
          {files.thumbnail?.name || "Existing image"}
        </p>
 ...
 <div className="space-y-3 border rounded-xl p-4 bg-white shadow-sm">
  ...
  {(videoPreview || form.introVideo) && (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between bg-gray-50 border rounded-lg px-3 py-2">
        <p className="text-sm text-gray-700 truncate max-w-[200px]">
          {files.introVideo?.name || "Existing video"}
        </p>
    ...
    <div className="flex items-center justify-between bg-gray-50 border rounded-lg px-3 py-2">
      ...
      <div className="flex items-center gap-2 overflow-hidden">
        ...
        <p className="text-sm text-gray-700 truncate max-w-[180px]">
          {files.syllabusPdf?.name || "Existing PDF"}
        </p>
      </div>
...
<div className="space-y-3 border rounded-xl p-4 bg-white shadow-sm">
  ...
  {/* Tag Input Box */}
  <div className="border rounded-md px-3 py-2 min-h-[40px] bg-white flex flex-wrap items-center gap-2">
